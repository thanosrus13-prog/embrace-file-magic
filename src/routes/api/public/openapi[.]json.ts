...
const spec = {
  ...
  components: {
    ...
    responses: {
      ...
      TooManyRequests: {
        description:
          'Per-user rate limit exceeded. See X-RateLimit-* headers and Retry-After for when to retry.',
        headers: {
